...
_Examples: Bug fixes, documentation improvements, small features_
...
_Examples: New dependencies, architectural changes, breaking changes_
...
_Examples: Licensing changes, project governance changes, Code of Conduct updates_
