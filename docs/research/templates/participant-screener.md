...
This screener helps identify and recruit appropriate participants for usability testing. Use it to ensure you get a diverse, representative sample of users.
...
**Subject**: Invitation: Usability Testing for Fawkes Platform - [Feature Name]
...
**Session Details:**
- **Duration**: 60 minutes
- **Format**: Remote via [Zoom/Teams/Google Meet]
- **Recording**: Yes (screen + audio, for note-taking only)
...
- [Other: Please suggest alternatives]

Reply to this email with your preferred time, and I'll send a calendar invite.
...
**Subject**: Thank You - Fawkes Platform Usability Testing
...
**Subject**: Reminder: Usability Testing Tomorrow at [Time]
...
This is a friendly reminder about your usability testing session tomorrow:
...
**Before the Session:**
- Please ensure you can access [test environment URL]
...
No problem! Just reply to this email or contact me at [phone/Slack].

Looking forward to learning from you tomorrow!
...
**Send within 1 hour after session**

**Subject**: Thank You - Fawkes Usability Testing
...
**What Happens Next:**
- Your responses will be anonymized and analyzed
- We'll share insights with the product and engineering teams
- You may see improvements based on your feedback in the coming months
