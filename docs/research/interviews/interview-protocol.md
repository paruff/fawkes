# Interview Protocol and Best Practices
...
3. [Interview Logistics](#interview-logistics)
4. [During the Interview](#during-the-interview)
5. [Post-Interview Process](#post-interview-process)
6. [Interview Best Practices](#interview-best-practices)
...
2. **Send calendar invite** with:
   ...
   - Expected duration (typically 45-60 minutes)
   - Video conferencing link (if remote)
   - Any preparation materials or pre-read
   - Contact information for questions
3. **Confirm participation** 24 hours before the interview
...
3. **Send Thank-You**:
   - Email or message within 1 hour if possible
...
3. **Highlight and Tag**:
   ...
   - **Workarounds**: Note what they do instead of ideal solution
   - **Feature requests**: Capture specific capability requests
   - **Emotional reactions**: Flag moments of frustration, delight, confusion

4. **File Interview Notes**:
   - Save in `docs/research/interviews/`
   - Use naming convention: `YYYY-MM-DD-{role}-{topic}.md`
   - Include metadata section at top (role, experience, date, interviewer)
   - Cross-reference related personas or journey maps
...
3. **Update Research Artifacts**:
   ...
   - Tag issues or epics with research insights

4. **Plan Follow-Up**:
   - Identify questions that need more research
   - Recruit participants for follow-up sessions
   - Plan validation studies for findings
...
**Consent Form**: See [Consent Form Template](./consent-form.md)
