...
- A new phase doesn't open until the previous phase's verification loop (`docs/PLATFORM_STATUS.md`, generated by the `golden-path-verification` workflow) shows genuinely green — not just "PRs merged" (`docs/elite-engineering-bridge-plan.md` Phase 4's phase-gate rule)
