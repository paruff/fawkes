    ...
    class KubectlHelper:
        ...
        def get_deployment(self, name, namespace):
            ...
            if name == "jenkins" and namespace == "fawkes":
                return {"name": "jenkins", "namespace": "fawkes", "replicas": 1, "ready_replicas": 1}
            return None
                        ...
                        "templates": [
                            {
                                "name": "jnlp-agent",
                                "label": "k8s-agent",
                                "containers": [{"image": "jenkins/inbound-agent:latest"}],
                                "instanceCapStr": "10",
                            ...
                            },
                            {
                                "name": "node-agent",
                                "label": "node nodejs",
                                "containers": [{"image": "node:20-slim"}, {"image": "jenkins/inbound-agent:latest"}],
                                "instanceCapStr": "5",
                                "idleTerminationMinutes": 10,
                            },
                            {
                                "name": "go-agent",
                                "label": "go golang",
                                "containers": [{"image": "golang:1.21"}, {"image": "jenkins/inbound-agent:latest"}],
                                "instanceCapStr": "5",
                                "idleTerminationMinutes": 10,
                            },
                        ],
