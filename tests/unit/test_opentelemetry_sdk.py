"""
Unit tests validating OpenTelemetry SDK 1.42.1 functionality.
...
def test_opentelemetry_sdk_version():
    """Confirm the installed SDK is 1.42.1."""
    import importlib.metadata

    version = importlib.metadata.version("opentelemetry-sdk")
    assert version == "1.42.1", f"Expected 1.42.1, got {version}"


@pytest.mark.unit
def test_opentelemetry_api_version():
    """Confirm the installed API is 1.42.1."""
    import importlib.metadata
