"""
Unit tests validating OpenTelemetry SDK 1.40.0 functionality.
...
def test_opentelemetry_sdk_version():
    """Confirm the installed SDK is 1.40.0."""
    import importlib.metadata

    version = importlib.metadata.version("opentelemetry-sdk")
    assert version == "1.40.0", f"Expected 1.40.0, got {version}"


@pytest.mark.unit
def test_opentelemetry_api_version():
    """Confirm the installed API is 1.40.0."""
    import importlib.metadata
