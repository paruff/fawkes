...
Sample Java Spring Boot application for testing Fawkes platform capabilities
...
# Or run the JAR
java -jar target/sample-java-app-0.1.0-SNAPSHOT.jar
```
...
kubectl get deployment sample-java-app
...
- **Metrics**: https://grafana.fawkes.idp/d/sample-java-app
- **Logs**: https://opensearch.fawkes.idp
- **Traces**: https://grafana.fawkes.idp/explore?ds=tempo
- **Health**: https://sample-java-app.fawkes.idp/actuator/health
