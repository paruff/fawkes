...
def mock_civo_client():
    ...
    client.objectstore.create = Mock(
        return_value={
            "id": "store-123",
            "name": "test-store",
            "max_size_gb": 500,
...
class TestCivoProviderAdvanced:
    ...
    def test_create_storage_with_max_size(self, civo_provider, mock_civo_client):
        ...
        config = StorageConfig(name="large-store", region="NYC1", metadata={"max_size_gb": 1000})
